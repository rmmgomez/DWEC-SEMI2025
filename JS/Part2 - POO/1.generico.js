...
// Crear objeto genérico JS sin usar JSON
let obj = new Object();
...
console.log("---- Objeto genérico pero usando JSON ----");
let obJSON = {
    nombre: "Peter",
    edad: 41,
    ...
    getInfo () { // Método
        return "Mi nombre en JSON es " + this.nombre + " y tengo " + this.edad
    }
}
console.log(obJSON.trabajos[1].descripcion); // Imprime "Conductor de autobús”